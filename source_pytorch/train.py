...
if __name__ == '__main__':
    ...
    ## Args for the three model parameters: input_features, hidden_dim, output_dim
    # Model Parameters
    ...
    parser.add_argument('--hidden_dim', type=int, default=5, metavar='H',
                       help='number of hidden layers of the model (default:5)')
    ...
    ## The optimizer and loss function for training
